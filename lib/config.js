...
const CONFIG = {
  ...
  // When false, conversations recorded in progress.failedConversationIds
  // (permanent 404s) are skipped instead of re-requested every run.
  retryFailedConversations: false,
