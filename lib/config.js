...
const CONFIG = {
  ...
  // Conversations recorded in progress.failedConversationIds are RETRIED by
  // default — a 404 is not trustworthy evidence of deletion (edge/bot blocking
  // produces them too). Opt in to skipping with --skip-failed.
  skipFailedConversations: false,
  // Force re-attempting conversations the server said this account has no
  // access to (normally skipped after 2 runs).
