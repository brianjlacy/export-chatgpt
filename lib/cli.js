...
function setupCLI() {
  ...
  program
    ...
    .option('--retry-failed', 'Re-attempt conversations previously recorded as permanently unavailable (HTTP 404). By default those are skipped on subsequent runs.', false)
...
async function main() {
  ...
  CONFIG.retryFailedConversations = !!opts.retryFailed;
